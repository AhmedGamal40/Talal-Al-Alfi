...
{/* <section className="text-gray-600 body-font mb-20">
  <div className="container mx-auto flex lg:justify-center flex-wrap">
    <div className="lg:w-[445px] sm:w-1/2 lg:h-[360px] mx-auto w-full overflow-hidden mt-6 sm:mt-0">
      <Image className="object-cover object-center w-full h-full" src={Teamwork} alt="statsc"/>
    </div>
    <div className='flex mx-7 lg:w-1/2 w-full text-center lg:text-start content-end sm:pr-10'>
