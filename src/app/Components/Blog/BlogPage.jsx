    ...
    <>
      <div  className="relative md:h-[415px] h-full bg-cover " >
        ...
        <div className="relative top-1/3 z-10 text-white text-start container mx-auto p-4">
          <h3 className="text-[16px] leading-[15.14px] font-[500] uppercase mb-8">Blog</h3>
          <p className="text-[32px] leading-[46.75px] font-[400]">
            In our blog, we provide you with <span className="font-bold">many legal <br/> articles</span> that you can read to learn more <br/> about <span className="font-bold">updated</span> legal information.
          </p>
        </div>
      </div>
    </>
