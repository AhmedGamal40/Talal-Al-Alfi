...
function BlogCard() {
  return (
    <>
      <div className=" py-4 mx-auto lg:max-w-7xl sm:max-w-full my-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-6">

        <div className="  rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
          <div className="  rounded text-white cursor-pointer absolute top-5 left-5 backdrop-blur-xl bg-[#FFFFFF/50%] py-1 px-2">
            7 June
          </div>

          <div className=" h-[288.75px] overflow-hidden ">
            <Image src={blog1} alt="Product 1" className="h-full w-full " />
          </div>

          <div className="py-6 bg-white">
            <h3 className="text-lg font-bold text-gray-800">Lorem ipsum dolor sit amet</h3>
